/** Global offer / deal pricing (hero card, badges, sticky CTA, body copy). Grand Sirenis Ultimate Leisure Club LP. */
...
export const CLUB_DISPLAY_NAME = 'Ultimate Leisure Club' as const;
...
export const OFFER_ROOM_SHORT = 'Deluxe Junior Suite, 2 adults, all-inclusive' as const;
...
/** Resort promo MP4 path under `public/` (wire Hero Lightbox `videoUrl` when asset is approved). */
export const RESORT_VIDEO_MP4_SRC = 'media/Grand-Sirenis-Riviera-Maya.mp4' as const;
